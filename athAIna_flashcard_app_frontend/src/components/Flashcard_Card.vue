...
export default {
  ...
  methods: {
    goFlashCard() {
      this.$router.push({ name: 'Flashcard', params: { id: this.flashcard.id } });
    },
    toggleModal(modal) {
        ...
        <div class="athAIna-border-outer p-[1.5px]">
          <div class="athAIna-border-inner">
              ...
              <div class="flex justify-end text-athAIna-red">
                ...
                <router-link :to="'/delete_flashcard/' + flashcard.id">
                <button class="p-2" @click.stop="toggleModal('deleteModal')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
