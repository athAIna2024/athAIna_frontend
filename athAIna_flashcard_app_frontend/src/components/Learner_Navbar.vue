...
<div v-if="modals.accSettings" class="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.5)] bg-opacity-50 z-40">
  ...
  <div class="w-full flex flex-row justify-between items-center p-7 pr-12 pl-12 z-50 sticky font-poppins shadow-md">
    ...
    <div class="flex flex-row justify-between items-center space-x-20">
      ...
      <div v-if="modals.profile" class="absolute top-[100px] right-[27px] h-[150px] w-[240px] border-athAIna-orange border-[4px] rounded-3xl bg-athAIna-white flex flex-col justify-between p-5">
