  ...
  <form class="mx-12 my-8">
      ...
      <div class="athAIna-border-outer p-1 shadow-xl">
        <div class="athAIna-border-inner py-4">
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="athAIna-border-outer p-1">
                  <div class="athAIna-border-inner py-1">
                    <textarea class="w-full rounded-lg p-4 border-0 text-athAIna-base text-athAIna-violet placeholder-athAIna-orange focus:outline-none" rows="5" placeholder="Write your question here."></textarea>
                  </div>
                </div>
                  ...
                  <div class="athAIna-border-outer p-1">
                    <div class="athAIna-border-inner py-1">
                      ...
                      <div class="flex flex-row items-center gap-2 justify-center my-2">
                        ...
                        <span class="text-athAIna-base">+ Insert Image</span>
                      </div>

                      <input type="file" accept="png, jpg" id="image-upload" class="hidden" />
                    </div>
                  </div>
                </label>
              </div>
          ...
          <div
              class="w-full size-[2px] bg-gradient-to-r from-athAIna-yellow via-athAIna-orange to-athAIna-red my-4"
          ></div>
          ...
          <div class="answer mx-16 my-2">
            <div class="border-athAIna-violet border-2 rounded-lg p-4 w-full">
              <div class="flex flex-col gap-4">
                ...
                <div class="athAIna-border-outer p-1">
                  <div class="athAIna-border-inner py-1">
                    <textarea class="w-full rounded-lg p-4 border-0 text-athAIna-base text-athAIna-violet placeholder-athAIna-orange focus:outline-none" rows="2" placeholder="Write your answer here."></textarea>
                  </div>
                </div>
              </div>
