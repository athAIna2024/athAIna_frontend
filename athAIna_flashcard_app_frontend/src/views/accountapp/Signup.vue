...
<template>
   <div class="mt-40 mr-40 pr-40 flex justify-center">
      <div class="absolute transform translate-x-28 translate-y-10 rotate-[12deg] left-48 shadow-md w-[450px] h-[525px] rounded-lg bg-gradient-to-br from-athAIna-red to-athAIna-yellow"></div>  
      <div class="absolute transform -translate-x-28 translate-y-10 rotate-[-12deg] left-48 shadow-md w-[450px] h-[525px] rounded-lg bg-gradient-to-br from-athAIna-red to-athAIna-yellow"></div>  
      <div class="absolute transform translate-x-0 left-48 w-[450px] h-[600px] rounded-lg border-4 bg-athAIna-white flex flex-col
      ">
